  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Card className="border-none shadow-premium bg-white/50 backdrop-blur-sm">
        ...
        {/* Clear all filters bar — same style as other pages */}
        {(salonId || rating || dateFrom || dateTo) && (() => {
          const cnt = [salonId, rating ? String(rating) : '', dateFrom, dateTo].filter(Boolean).length;
          return (
            <div className="px-6 py-2 bg-amber-50 border-b border-amber-100 flex items-center justify-between animate-in slide-in-from-top-1 duration-200">
              ...
              <button
                onClick={() => { setSalonId(undefined); setRating(undefined); setDateFrom(''); setDateTo(''); }}
