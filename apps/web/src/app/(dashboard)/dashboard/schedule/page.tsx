...
export default function AdminSchedulePage() {
  ...
  const bulkCreateMutation = useMutation({
    mutationFn: (data: { salonId: string; staffIds: string[]; dates: string[]; type: string }) => adminApi.bulkCreateSchedules(data),
    ...
    <div className="space-y-6 pb-10 animate-in fade-in duration-500">
      ...
      {!selectedSalonId ? (
        <div className="bg-slate-50/50 rounded-2xl p-24 flex flex-col items-center justify-center border-2 border-dashed border-slate-200">
            <Store className="w-10 h-10 text-slate-200 mb-4" />
