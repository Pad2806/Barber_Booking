  ...
  return (
    <div className="space-y-12 transition-all duration-1000 animate-in fade-in slide-in-from-bottom-8">
      <div className="space-y-4">
         <span className="text-[10px] font-black text-gray-300 uppercase tracking-[0.4em] block">WELCOME BACK</span>
        <h2 className="text-6xl font-heading font-black text-gray-900 tracking-tighter uppercase italic leading-none">Đăng nhập</h2>
        <p className="text-sm font-light text-gray-500 tracking-tight">Vui lòng nhập thông tin để tiếp tục trải nghiệm cùng REETRO.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <label htmlFor="password" className="text-[10px] font-black text-gray-300 uppercase tracking-[0.3em] font-mono italic px-2">PASSWORD</label>
            <div className="relative group">
            ...
            <div className="flex justify-end px-2">
               <Link href="/forgot-password" title="Forgot Password" className="text-[10px] font-black text-gray-300 uppercase tracking-widest hover:text-black transition-colors">QUÊN MẬT KHẨU?</Link>
            </div>
          </div>
        </div>
        ...
        >
          {isLoading ? (
            ...
            <div className="flex items-center gap-4">
               LOGIN <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform duration-500" />
            </div>
          )}
        </button>
      </form>
      ...
      <div className="space-y-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-[10px] font-black uppercase tracking-[0.4em]">
            <span className="px-6 bg-white text-gray-300 italic font-mono">OR SIGN IN WITH</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-4 bg-gray-50 border border-gray-100 text-[10px] font-black uppercase tracking-widest text-black py-4 rounded-full hover:bg-black hover:text-white transition-all duration-700"
          >
      ...
      <div className="pt-8 text-center border-t border-gray-100">
         <p className="text-[10px] font-black text-gray-300 uppercase tracking-[0.2em] mb-4">MỚI BIẾT ĐẾN REETRO?</p>
         <Link href="/register" className="inline-block px-12 py-4 border-2 border-black rounded-full font-black text-[10px] uppercase tracking-[0.3em] hover:bg-black hover:text-white transition-all duration-700 active:scale-95">
           CREATE ACCOUNT
         </Link>
      </div>
    </div>
